    ...
    <div style={{minHeight:'100vh', background:'#f8fafc'}}>
      ...
      <nav className="navbar px-3 px-md-4 shadow-sm"
        ...
        <div className="d-flex align-items-center gap-2">
          ...
          <span className="navbar-brand fw-bold text-white fs-5 fs-md-4 mb-0">ConnectDoc <span className="fs-6 opacity-75 fw-normal d-none d-md-inline">| Admin Panel</span></span>
        </div>
        <div className="ms-auto d-flex align-items-center gap-2 gap-md-3">
          <div className="px-2 px-md-3 py-1 rounded-pill" style={{background:'rgba(255,255,255,0.1)', border:'1px solid rgba(255,255,255,0.15)'}}>
            <span className="text-white small">
              Welcome, <b style={{color:'#38bdf8'}}>{user?.name || user?.username || 'Admin'}</b>
            </span>
          </div>
      ...
      <div className="d-flex dashboard-layout">
        ...
        <div className="bg-white shadow-sm pt-3 pt-md-4 px-3 dashboard-sidebar"
          ...
          <p className="text-muted small fw-bold px-2 mb-2 mb-md-3 text-uppercase" style={{letterSpacing:'0.05em'}}>Admin Management</p>
